package codeacademy.learnintermediatejava.threading.waitnotifyall;
...
public class CakeMaker {
    ...
    public void mixDryIngredients() {
        ...
        try {
            ...
            // The block under synchronized allows to access the mixingBowlInUse variable in a synchronized way
            // When the bowl is in use any other Thread trying to access it will wait until the resource
            // is freed
            synchronized(this){
            ...
            // The command notifyAll() will indicate to any Thread that is waiting for the resource that the resource
            // has been freed up so any other thread can come and get it
            synchronized(this){
